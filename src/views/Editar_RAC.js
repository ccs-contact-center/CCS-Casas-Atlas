      ...
      this.API_CCS.insertRAC(ticket)
        .then(async (res) => {
          if (res.sucess === true) {
            ...
            var SJO =
              "isaac.contreras@ccscontactcenter.com, iacontrerasg@gmail.com,brenda.hernandez@ccscontactcenter.com";
              ...
              <Col className="col-sm-4">
                <FormGroup>
                  ...
                  >
                    ...
                    <option value="PROVENZA AVIÃ‘ON">PROVENZA AVIÃ‘ON</option>
